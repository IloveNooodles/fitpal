...
class RegisterWindow(QWidget):
  ...
  def setUpWidgets(self):
    ...
    subheading.setText("Create an account to enjoy a new experience in working out!")
    ...
    self.rbUser.setStyleSheet(f'background-color: {card_bg}; color: {gray}')
    ...
    self.rbTrainer.setStyleSheet(f'background-color: {card_bg}; color: {gray}')
