...
class UserDashboard(QWidget):
  ...
  def setUpWidgets(self):
    ...
    pHeading.setStyleSheet(f"color: rgba(0, 0, 0, 0.5); background-color: {light_purple}")
    pText = QLabel(self)
    pText.setText("Don’t forget to mark your daily workout wins here!")
    pText.setFont(inter13)
    pText.move(520, 477)
    pText.setStyleSheet(f"color: rgba(0, 0, 0, 0.5); background-color: {light_purple}")
    ...
    goCompleteWorkoutBtn.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
